			...
			<div class="card">
				...
				<div class="card-body">
					<div class="row">
						...
						<div class="col-md-6 form-group">
							<a href="<?= base_url('ventas') ?>" style="text-decoration: none"><button type="button" class="btn btn-primary btn-lg btn-block"><h2><i class="fas fa-money-bill-wave"></i> | VENTAS</h2></button></a>
						</div>
						<div class="col-md-6 form-group">
